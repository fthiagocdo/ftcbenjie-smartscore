...
<div class="limiter">
	<div class="container-login100">
        <div class="wrap-login100">
			...
			<h2 class="pt-2 text-center font-weight-bold">Adicionar Juiz</h2>
			<form class="login100-form validate-form pt-3 pb-3" method="post" action="{{ route('site.judges.save') }}" enctype="multipart/form-data">
